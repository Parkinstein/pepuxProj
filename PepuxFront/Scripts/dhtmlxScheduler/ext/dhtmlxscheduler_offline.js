...
for(var i in e)n.push({id:i,data:e[i],operation:this.getState(i)});return void this.serverProcessor._send(n,a,this)}var l=new dtmlXMLLoaderObject(this.afterUpdate,this,!0),r=this.serverProcessor+(this._user?getUrlSymbol(this.serverProcessor)+["dhx_user="+this._user,"dhx_version="+this.obj.getUserData(0,"version")].join("&"):"");"POST"!=this._tMode?l.loadXML(r+(-1!=r.indexOf("?")?"&":"?")+this.serialize(e,t)):l.loadXML(r,!0,this.serialize(e,t)),this._waitMode++}},e._updatesToParams=function(e){for(var t={},a=0;a<e.length;a++)t[e[a].id]=e[a].data;
